...
public class UsersController {
	...
	@PostMapping("/delete")
	public Result delete( DeleteUserRequest delereDeleteUserRequest) {
		userService.delete(delereDeleteUserRequest);
	...
	public DataResult<User> getById(GetUserResponse getUserResponse){
		return this.userService.getById(getUserResponse);
